...
import br.jus.trt23.contavinculada.crud.jsf.util.JsfUtil;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/MyBundle2").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/MyBundle2").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/MyBundle2").getString("PersistenceErrorOccured"));
            }
        }
    }
