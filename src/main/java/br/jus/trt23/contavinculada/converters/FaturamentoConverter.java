...
import br.jus.trt23.contavinculada.sessions.FaturamentoFacade;
...
public class FaturamentoConverter implements Converter {
    @Inject
    private FaturamentoFacade facade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Faturamento) {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Faturamento.class.getName()});
            return null;
        }
    }    
}
