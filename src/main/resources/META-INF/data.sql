...
-- Started on 2016-06-24 09:39:31
...
--
-- TOC entry 2426 (class 0 OID 32146)
-- Dependencies: 187
...
--
-- TOC entry 2428 (class 0 OID 32157)
-- Dependencies: 189
...
--
-- TOC entry 2430 (class 0 OID 32165)
-- Dependencies: 191
...
--
-- TOC entry 2432 (class 0 OID 32176)
-- Dependencies: 193
...
--
-- TOC entry 2434 (class 0 OID 32184)
-- Dependencies: 195
...
--
-- TOC entry 2436 (class 0 OID 32195)
-- Dependencies: 197
-- Data for Name: contrato; Type: TABLE DATA; Schema: public; Owner: contratosADM
--

INSERT INTO contrato (id, criadoem, destruidoem, vigenteate, vigentedesde, arp, assinaturadata, contasvinculadas, inteiroteor, numero, objeto, processo, regimetributacao, situacao, aditivode_id, contratado_id) VALUES (1, '2016-06-22 00:00:00', NULL, '2021-05-31 00:00:00', '2016-06-01 00:00:00', NULL, '2016-05-20', NULL, NULL, '14/2016', 'Postos de trabalho para serviços gerais', 'Proad 12/2016', NULL, NULL, NULL, NULL);
INSERT INTO contrato (id, criadoem, destruidoem, vigenteate, vigentedesde, arp, assinaturadata, contasvinculadas, inteiroteor, numero, objeto, processo, regimetributacao, situacao, aditivode_id, contratado_id) VALUES (2, '2016-03-12 00:00:00', NULL, '2017-03-31 00:00:00', '2016-04-01 00:00:00', NULL, '2016-03-11', NULL, NULL, '13/2016', 'Postos de trabalho para vigilância', 'Proad 08/2016', NULL, NULL, NULL, NULL);
INSERT INTO contrato (id, criadoem, destruidoem, vigenteate, vigentedesde, arp, assinaturadata, contasvinculadas, inteiroteor, numero, objeto, processo, regimetributacao, situacao, aditivode_id, contratado_id) VALUES (3, '2015-09-22 00:00:00', NULL, '2020-09-30 00:00:00', '2015-10-01 00:00:00', NULL, '2015-09-13', NULL, NULL, '07/2015', 'Postos de trabalho para copeira', 'Proad 03/2015', NULL, NULL, NULL, NULL);
...
--
-- TOC entry 2437 (class 0 OID 32204)
-- Dependencies: 198
...
--
-- TOC entry 2438 (class 0 OID 32207)
-- Dependencies: 199
...
--
-- TOC entry 2440 (class 0 OID 32212)
-- Dependencies: 201
...
--
-- TOC entry 2442 (class 0 OID 32223)
-- Dependencies: 203
...
--
-- TOC entry 2443 (class 0 OID 32229)
-- Dependencies: 204
...
--
-- TOC entry 2445 (class 0 OID 32234)
-- Dependencies: 206
...
--
-- TOC entry 2446 (class 0 OID 32240)
-- Dependencies: 207
...
--
-- TOC entry 2448 (class 0 OID 32245)
-- Dependencies: 209
...
--
-- TOC entry 2450 (class 0 OID 32256)
-- Dependencies: 211
...
--
-- TOC entry 2452 (class 0 OID 32264)
-- Dependencies: 213
...
--
-- TOC entry 2454 (class 0 OID 32272)
-- Dependencies: 215
...
--
-- TOC entry 2456 (class 0 OID 32280)
-- Dependencies: 217
...
--
-- TOC entry 2458 (class 0 OID 32288)
-- Dependencies: 219
...
--
-- TOC entry 2460 (class 0 OID 32296)
-- Dependencies: 221
...
--
-- TOC entry 2462 (class 0 OID 32307)
-- Dependencies: 223
...
--
-- TOC entry 2464 (class 0 OID 32315)
-- Dependencies: 225
...
--
-- TOC entry 2466 (class 0 OID 32326)
-- Dependencies: 227
...
--
-- TOC entry 2468 (class 0 OID 32337)
-- Dependencies: 229
...
--
-- TOC entry 2469 (class 0 OID 32346)
-- Dependencies: 230
...
--
-- TOC entry 2470 (class 0 OID 32349)
-- Dependencies: 231
...
--
-- TOC entry 2471 (class 0 OID 32352)
-- Dependencies: 232
...
--
-- TOC entry 2473 (class 0 OID 32357)
-- Dependencies: 234
...
--
-- TOC entry 2475 (class 0 OID 32365)
-- Dependencies: 236
...
--
-- TOC entry 2479 (class 0 OID 32381)
-- Dependencies: 240
...
-- Completed on 2016-06-24 09:39:31
